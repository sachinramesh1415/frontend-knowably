...
@NgModule({
  declarations: [AppComponent, ExpertValidateDashboardComponent, DialogOverviewExampleDialog, ExpertLoginComponent, ExpertRegisterComponent, ExpertDashboardComponent, DashboardComponent, MovieDomainSearchComponent, MedicalDomainSearchComponent, SearchResultComponent, ExpertAnalyticsComponent, ExpertAnalyticsMovieComponent, ExpertAnalyticsMedicalComponent, ExpertAnalyticsGraphComponent, ExpertQueriesComponent],
  imports: [BrowserModule, AppRoutingModule, MatDialogModule, MatFormFieldModule, MatInputModule, MatIconModule, FormsModule, HttpClientModule, PapaParseModule, BrowserAnimationsModule, MatTableModule, MatButtonModule, MatCardModule],
